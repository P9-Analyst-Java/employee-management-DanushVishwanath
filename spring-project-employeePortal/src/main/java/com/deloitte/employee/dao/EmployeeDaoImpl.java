...
public class EmployeeDaoImpl implements EmployeeDao{
	...
	public List<Employee> search(String name) {
		...
		String sql="select * from employees where first_name like '%"+name+"%' or last_name like '%"+name+"%'";
	...
	public List<EmploymentHistory> findHistory(Long empId) {
		return jdbcTemplate.query("select * from employement_history where emp_id=?",new BeanPropertyRowMapper<EmploymentHistory>(EmploymentHistory.class),empId );
		}
